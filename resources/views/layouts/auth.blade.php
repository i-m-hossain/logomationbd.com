...
<head>
    ...
    <title>Admin Ecommerce Dashard</title>
...
{{--                <li class="nav-item"><a href="{{route('products.index')}}" class="nav-link">All Product</a></li>--}}
        ...
        <ul class="sl-menu-sub nav flex-column">
{{--            <li class="nav-item"><a href="{{route('newsletter.index')}}" class="nav-link">Newsletter</a></li>--}}
...
{{--                            <li><a href="{{route('admin.password.change')}}"><span><i class="icon ion-ios-gear-outline"></i></span>Change Password</a></li>--}}
{{--                            <li><a href="{{route('admin.logout')}}"><i class="icon ion-power"></i> Sign Out</a></li>--}}
                            <li>
                                ...
                                <form action="{{route('logout')}}" id= "logout-form"method="post" display="none">
                                    @csrf
                                </form>
                            </li>
                        </ul>
